...
public class VehiculosDAO {
    ...
    public static ArrayList<String> listarVehiculos(ConnectionDB conexion) {
        ...
        try {
            ...
            PreparedStatement statement = conexion.getConnection().prepareStatement(
                "SELECT v.mat_veh, v.marca_veh, v.kms_veh, v.precio_veh, v.desc_veh, p.id_prop, p.nombre_prop, p.dni_prop FROM vehiculo v, propietario p WHERE v.id_prop = p.id_prop "
            );
    ...
    public static ArrayList<String> listarVehiculosMarca(ConnectionDB conexion, String marca_veh) {
        ...
        try {
            ...
            PreparedStatement statement = conexion.getConnection().prepareStatement(
                "SELECT v.mat_veh, v.marca_veh, v.kms_veh, v.precio_veh, v.desc_veh, p.id_prop, p.nombre_prop, p.dni_prop FROM vehiculo v, propietario p WHERE v.id_prop = p.id_prop AND v.marca_veh = ?"
            );
    ...
    public static ArrayList<String> recuperarVehiculos(ConnectionDB conexion) {
        ...
        try {
            ...
            PreparedStatement statement = conexion.getConnection().prepareStatement(
             "SELECT v.mat_veh, v.marca_veh, v.kms_veh, v.precio_veh, v.desc_veh, v.id_prop FROM vehiculo v "
            );
